 ...
 * @since 31-03-2022
 */
class CMPIntegranteCambioTipoForm extends CMPForm{

	public function getRenderer(){
		return new CMPIntegranteCambioTipoFormRenderer();
	}
	...
	public function __construct($action="", $id="edit_matriculado") {
		...
		//$fieldCargo->getInput()->setIsEditable(false);
		...
		//$fieldCarrerainv->getInput()->setIsEditable(false);
		...
		//$fieldOrganismo->getInput()->setIsEditable(false);
		...
		//$fieldBeca->getInput()->setIsEditable(false);
		$fieldset->addField( $fieldBeca );

		$fieldBeca = FieldBuilder::buildFieldSelect (CYT_LBL_INTEGRANTE_TIPO_BECA, "ds_tipobeca", Tipobeca::getItems(), "", null, null, "--seleccionar--" );
		//print_r($fieldBeca);
		//$fieldBeca->getInput()->setIsEditable(false);
		$fieldset->addField( $fieldBeca );
		...
		$field = FieldBuilder::buildFieldDate ( CYT_LBL_INTEGRANTE_FECHA_CAMBIO, "dt_cambioHS",CYT_MSG_INTEGRANTE_FECHA_CAMBIO_REQUIRED) ;
		$field->getInput()->setIsVisible(false);
		$fieldset->addField( $field );

		$field = FieldBuilder::buildFieldTextArea ( CYT_LBL_INTEGRANTE_CAMBIAR_HS_REDUCCION, "ds_reduccionHS","","",4,100) ;
		$field->getInput()->setIsVisible(false);
		$fieldset->addField( $field );
		...
		$this->addHidden( FieldBuilder::buildInputHidden ( "nu_horasinvAnt", "") );
